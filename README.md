...
- **[Download PDF (Greek)](Usage/Thesis_Vasileios_Charalampakis.pdf):** For Greek speakers, the full thesis document is available, including detailed methodology and instructions on how to use both IEEE and CENELEC standards.
- **[USAGE (English)](Usage/):** A brief guide on how to use the software for English-speaking users. Includes instructions on installation, usage, and parameters for both IEEE and CENELEC standards.
